...
class SubtitleTimeline extends React.Component<Props, State> {
    ...
    constructor(props: any) {
        ...
        this.stepSelectionHandler = this.stepSelectionHandler.bind(this)
    ...
    stepSelectionHandler(index: number) {
    ...
    setTimeFromPixels(timePerPixels: number) {
        this.props.onTimeChanged(timePerPixels / this.state.scale)
    }
    //  ------------------- component API ----------------------
        ...
        return (
            <div className="advanced-timeline">
                ...
                <div className="zoom-btn-group">
                    <button className="btn circle-btn" onClick={() => this.zoom(10)}>
